...
type UserStarConfig struct {
	...
	PenaltyRate          int       `json:"penaltyRate" gorm:"column:penalty_rate"`                   // 违约金比例(百分比)
...
func (m *UserStarConfig) TableName() string {
	return "t_user_star_config"
}
